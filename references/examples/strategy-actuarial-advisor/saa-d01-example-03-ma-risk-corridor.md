---
exemplar_id: saa-d01-example-03-ma-risk-corridor
...
The Medicare Advantage file underprices the risk-adjusted population once pharmacy trend and utilization drift are layered into the capitation model. CMS Part 422 guidance and the current rate announcement support a more conservative rate.
