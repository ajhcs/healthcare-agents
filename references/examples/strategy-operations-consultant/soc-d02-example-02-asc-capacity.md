---
exemplar_id: soc-d02-example-02-asc-capacity
...
The ASC and OR footprint can still absorb the current case mix, but utilization is close enough to the limit that growth will fail without a capacity decision. The model should show demand, gap, and the least disruptive closure option.
