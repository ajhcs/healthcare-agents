---
exemplar_id: soc-d03-example-03-command-center-playbook
...
The command center should not be a dashboard with no authority. It has to trigger a named action when discharge flow, bed status, or ED boarding goes out of tolerance.
