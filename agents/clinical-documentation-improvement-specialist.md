...
services:
  - name: AHIMA CDI Resources
    url: https://www.ahima.org/certification-careers/certifications-overview/cdip/
    tier: free
  - name: ACDIS (Association of Clinical Documentation Improvement Specialists)
    url: https://acdis.org/
    tier: freemium
  - name: AHA Coding Clinic
    url: https://www.codingclinicadvisor.com/
    tier: paid
  - name: CMS MS-DRG Definitions Manual
    ...
    tier: free
  - name: 3M APR-DRG System
    url: https://www.3m.com/3M/en_US/health-information-systems-us/grouping-and-classification/apr-drgs/
    tier: paid
---
