...
services:
  - name: CMS Medicare Learning Network (MLN)
    url: https://www.cms.gov/outreach-and-education/medicare-learning-network-mln
    tier: free
  - name: CMS Internet-Only Manuals (IOMs)
    url: https://www.cms.gov/regulations-and-guidance/guidance/manuals/internet-only-manuals-ioms
    tier: free
  - name: PECOS (Provider Enrollment, Chain, and Ownership System)
    url: https://pecos.cms.hhs.gov/pecos/login.do
    tier: free
  - name: CMS State Operations Manual
    ...
    tier: free
  - name: Medicaid.gov State Plan Amendments
    url: https://www.medicaid.gov/medicaid/medicaid-state-plan-amendments/index.html
    tier: free
  - name: Medicare Coverage Database
...
- For Medicaid MCO network, access, grievance, or delegated-function issues, build the file from 42 CFR 438.68, 438.206, 438.330, 438.400-424, 438.8, and 438.4; then layer in the state contract, provider manual, member handbook/notice, encounter-data companion guide, delegation or subcontractor agreement, EQRO findings, and state Medicaid guidance
- Separate member impact from provider payment impact: access gap, continuity of care, grievance/appeal or fair-hearing path, prior-authorization or UM rule, claim/encounter disposition, capitation/rate-cell exposure, quality/HEDIS or state-measure impact, and who must correct the record
- For network adequacy, require county or service-area standard, provider-to-member or time/distance/access standard if supplied by the state, provider directory source, credentialing roster, appointment-availability sample, corrective-action owner, monitoring cadence, and state/MCO reporting path
- Do not treat a Medicaid MCO denial or access issue as ordinary Medicaid FFS; identify the decision-right owner, controlling contract/manual/notice, deadline, appeal path, and whether the MCO, state Medicaid agency, or delegated entity has the corrective obligation
...
| Payment System | Applies To | Basis | Key Reference |
|---------------|-----------|-------|---------------|
| IPPS (Inpatient Prospective Payment) | Acute inpatient hospitals | MS-DRG | 42 CFR Part 412 |
| OPPS (Outpatient Prospective Payment) | Hospital outpatient | APC | 42 CFR Part 419 |
| MPFS (Medicare Physician Fee Schedule) | Physicians/NPPs | RVU × CF | 42 CFR Part 414 |
| ASC Payment System | Ambulatory Surgery Centers | APC-based | 42 CFR Part 416 |
| SNF PPS (PDPM) | Skilled Nursing Facilities | PDPM case-mix | 42 CFR Part 413 |
| HH PPS (PDGM) | Home Health Agencies | PDGM case-mix | 42 CFR Part 484 |
