...
services:
  - name: Commission for Case Manager Certification (CCMC)
    url: https://ccmcertification.org/
    tier: free
  - name: ACMA (American Case Management Association)
    url: https://www.acmaweb.org/
    tier: freemium
  - name: CMS Discharge Planning CoPs
    url: https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment/AcuteInpatientPPS
    tier: free
  - name: CMS Post-Acute Care Payment Systems
    url: https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment
    tier: free
  - name: Navihealth (Post-Acute Care Navigation)
    url: https://navihealth.com/
    tier: paid
---
