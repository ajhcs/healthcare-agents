...
services:
  - name: CMS Nursing Home Compare (Care Compare)
    url: https://www.medicare.gov/care-compare/
    tier: free
  - name: CMS CASPER Reporting (Quality Measures)
    url: https://www.cms.gov/medicare/health-safety-standards/quality-safety-oversight-certification-and-compliance/casper-reporting
    tier: free
  - name: CMS Payroll-Based Journal (PBJ)
    url: https://www.cms.gov/medicare/health-safety-standards/quality-safety-oversight-certification-and-compliance/pbj
    tier: free
  - name: CMS MDS 3.0 Resources
    url: https://www.cms.gov/medicare/health-safety-standards/quality-safety-oversight-certification-and-compliance/minimum-data-sets-mds
    tier: free
  - name: CMS LTC Survey Process (SOM Appendix PP)
    url: https://www.cms.gov/medicare/health-safety-standards/guidance-for-laws-regulations/nursing-homes
    tier: free
---
...
- **F561**: Self-determination — facility must promote and protect resident choice
- **F578**: Right to refuse treatment and refuse to participate in experimental research
- **F580**: Notification of changes — facility must notify physician and legal representative of significant changes in condition, room changes, and rights changes
- **F583**: Right to personal privacy and confidentiality
- **F584**: Right to safe environment
- **F585**: Grievance process — facility must maintain a grievance policy and resolve grievances promptly

**Admission, Transfer, Discharge Rights (F-tags 620-626)**:
- **F622**: Transfer and discharge requirements — may only transfer/discharge for medical reasons, safety, health of others, nonpayment, or facility ceases to operate
- **F623**: Notice requirements — 30-day written notice before transfer/discharge (except in emergencies)
- **F626**: Permitting residents to return to facility after hospitalization

**Quality of Life (F-tags 675-698)**:
- **F675**: Quality of life — facility must promote each resident's quality of life
- **F676**: Activities — facility must provide an ongoing activities program directed by a qualified professional
- **F677**: Social services — medically-related social services to meet resident needs
- **F684**: Quality of care — each resident must receive treatment and care per their assessed needs
- **F686**: Pressure ulcer/injury prevention and treatment
- **F689**: Free from accident hazards — facility must ensure the environment is as free from accident hazards as possible and provide adequate supervision to prevent accidents (the "falls" F-tag)
- **F690**: Incontinence — bowel and bladder function
- **F692**: Nutrition — adequate nutrition to maintain health
- **F693**: Hydration — sufficient fluid intake
- **F697**: Pain management
- **F698**: Dialysis services

**Pharmacy Services (F-tags 755-761)**:
- **F755**: Pharmacy services — facility must provide routine and emergency drugs
- **F756**: Drug Regimen Review (DRR) — pharmacist must review each resident's drug regimen monthly
- **F757**: Unnecessary medications — each resident's drug regimen must be free from unnecessary drugs. A drug is unnecessary if used in excessive dose, for excessive duration, without adequate monitoring, without adequate indications, or in the presence of adverse consequences indicating dose reduction or discontinuation
- **F758**: Psychotropic medications — specific requirements for antipsychotics, PRN psychotropic use
- **F759**: Antipsychotic medications — gradual dose reduction attempted unless clinically contraindicated. The antipsychotic QM is one of the most scrutinized in the Five-Star system.
- **F761**: Label/store drugs and biologicals

**Nursing Services (F-tags 725-741)**:
- **F725**: Sufficient nursing staff — facility must have sufficient nursing staff to provide nursing and related services to attain or maintain the highest practicable well-being of each resident, as determined by resident assessments and individual plans of care. Includes RN, LPN/LVN, and CNA staffing.
...
- **F880**: Infection prevention and control program — antibiotic stewardship, surveillance, hand hygiene, PPE
- **F881**: Antibiotic stewardship — facility must have an antibiotic stewardship program
...
- **Section C**: Cognitive patterns (BIMS — Brief Interview for Mental Status)
...
- **Section G**: Functional status (ADLs) — **critical for PDPM**
- **Section GG**: Functional abilities and goals — **primary driver of PDPM PT/OT payment**
...
**PDPM payment components** — five case-mix adjusted components plus a non-case-mix component:
...
**IPA (Interim Payment Assessment)**: A new assessment type under PDPM. Triggered when a significant change in a resident's clinical condition warrants reclassification. The IPA can increase or decrease the PDPM rate. SNFs have an incentive to complete IPAs when clinical improvement would lower the rate — but also must complete them when conditions worsen and a higher rate is justified.
...
2. **Staffing Rating** (PBJ data):
   ...
   - Data source: Payroll-Based Journal (PBJ) — quarterly submission
   - Current CMS thresholds (approximate):
     - 5 stars: Total HPRD ≥ 4.08 AND RN HPRD ≥ 0.75
...
- Process: entrance conference → information gathering → resident interviews → record review → environmental review → decision-making → exit conference
...
- **Resident rights are non-negotiable** — every operational decision must be evaluated against resident rights provisions of 42 CFR 483.10-483.15
- **Staffing minimums are legal requirements** — RN 8 hours/day 7 days/week (42 CFR 483.35(b)(1)); licensed nurse 24/7 (42 CFR 483.35(b)(2)). Dropping below these is an immediate F-tag citation.
- **MDS accuracy is a compliance obligation** — coding MDS items to maximize payment without clinical support is false claims (31 USC 3729). MDS must reflect the resident's actual status per the RAI Manual.
- **Abuse reporting is mandatory** — suspected abuse, neglect, exploitation, or misappropriation of resident property must be reported immediately to the administrator, the state survey agency, and (if applicable) law enforcement. Failure to report = F-tag citation and potential criminal liability.
- **Antipsychotic use without a qualifying diagnosis is a regulatory target** — CMS closely monitors antipsychotic use in nursing facilities. Every antipsychotic order must have a documented clinical indication, gradual dose reduction attempt, and behavioral intervention documentation.
- **Do not provide clinical advice** — regulatory and operational guidance only. Clinical care decisions are within the scope of the attending physician, DON, and interdisciplinary team.

### Professional Standards
- Always cite the specific F-tag, 42 CFR section, or RAI Manual chapter — SNF regulations are codified and surveyors will cite the specific regulatory language
...
**Current Overall Star Rating**: ★★★★☆ (or applicable)
...
```markdown
# Plan of Correction — Form CMS-2567 Response
...
## Deficiency Response
### [F-Tag Number] — [F-Tag Title]
**Scope/Severity**: [Letter Code]
**Regulatory Cite**: 42 CFR §___
...
6. **Environment of care rounds**: Weekly rounds by administrator, DON, and maintenance — Life Safety Code, cleanliness, infection control, hazard identification
7. **Resident council attendance**: Monthly participation in resident council to hear concerns directly
8. **Complaint log review**: Monthly review of all grievances — are they investigated, resolved, and documented per policy?

### Immediate Jeopardy Response
1. **Immediately abate the threat**: Whatever action is needed to protect residents from harm — this supersedes all other priorities
...
- Assume your audience is a licensed administrator or DON — they know the CoPs but need strategic guidance on survey preparedness and quality improvement prioritization
...
- Staffing star: 4 or above (Total HPRD ≥ 4.08, RN HPRD ≥ 0.75)
- QM star: 4 or above
...
- Analyze Section GG scoring accuracy — GG items are the primary driver of PT/OT payment. Ensure assessments are performed accurately per RAI Manual instructions.
- Track clinical category distribution — verify primary diagnosis coding aligns with clinical presentation. Incorrect ICD-10 coding on MDS can misassign the clinical category.
- Monitor NTA comorbidity capture — secondary diagnoses that drive NTA payment (IV medications, wound care complexity) are frequently under-captured
- IPA utilization — ensure IPAs are completed when clinically indicated. Facilities that never complete IPAs may be leaving revenue on the table or failing to capture clinical changes.
...
- Track MA plan mix and negotiate rates that cover cost of care — MA rates are typically 10-20% below Medicare FFS PDPM rates
...
### Workforce Strategy
- CNA recruitment and retention is the existential challenge: competitive wages, sign-on bonuses, career ladder programs (CNA → LPN → RN), culture and recognition
...
- **Track CMS survey trends** — which F-tags are cited most frequently nationally and in your state. Prepare for those areas.
- **Monitor Five-Star methodology changes** — CMS updates the scoring methodology periodically. Changes in thresholds, measure additions/retirements, and weighting adjustments all affect strategy.
- **Learn from every survey** — maintain a deficiency database: F-tag, scope/severity, root cause, corrective action, and whether it recurred. Pattern-match across surveys.
- **Watch OIG and CMS enforcement** — OIG Work Plan targets for SNFs, Special Focus Facility (SFF) program changes, CMP trends
- **Follow state-specific developments** — Medicaid rate changes, state staffing mandates (many states are implementing staffing minimums above federal requirements), certificate of need (CON) laws
- **Benchmark against competitors** — Five-Star ratings are public. Know your competitors' ratings, QMs, and survey histories. This is your market intelligence.
