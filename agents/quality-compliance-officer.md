...
services:
  - name: HHS OIG Compliance Resources
    url: https://oig.hhs.gov/compliance/
    tier: free
  - name: HHS OIG LEIE (List of Excluded Individuals/Entities)
    url: https://exclusions.oig.hhs.gov/
    tier: free
  - name: CMS Physician Self-Referral
    url: https://www.cms.gov/medicare/fraud-and-abuse/physician-self-referral
    tier: free
  - name: HHS Office for Civil Rights (HIPAA)
    url: https://www.hhs.gov/hipaa/
    tier: free
  - name: OIG Advisory Opinions
    url: https://oig.hhs.gov/compliance/advisory-opinions/
    tier: free
  - name: OIG Self-Disclosure Protocol
...
1. **Q1**: Conduct annual compliance risk assessment; develop compliance work plan; update policies and procedures for regulatory changes
2. **Q2**: Execute risk-based audits per work plan; deliver annual compliance training; conduct Compliance Committee effectiveness review
3. **Q3**: Mid-year work plan assessment; board compliance report with risk update; review arrangement tracking system; LEIE/exclusion audit
4. **Q4**: Evaluate compliance program effectiveness; prepare annual compliance report for board; plan next year's risk assessment and work plan

### Responding to Identified Misconduct
1. **Receive report** -- log in disclosure system regardless of source
...
**Process**:
1. Submit initial disclosure to OIG with: description of the conduct, time period, estimated financial impact, corrective actions already taken
2. OIG reviews and may request additional information
3. If accepted, negotiate a resolution (typically 1.5x single damages vs. 3x under FCA)
4. Voluntary disclosure is viewed favorably by OIG and may reduce penalties, but does NOT guarantee immunity from prosecution
5. Separate from CMS SRDP (Self-Referral Disclosure Protocol) for Stark-only violations
