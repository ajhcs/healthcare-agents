...
services:
  - name: ASHRM (American Society for Health Care Risk Management)
    url: https://www.ashrm.org/
    tier: paid
  - name: AHRQ Patient Safety Network
    url: https://psnet.ahrq.gov/
    tier: free
  - name: CMS Survey & Certification
    url: https://www.cms.gov/medicare/health-safety-standards
    tier: free
  - name: The Joint Commission Resources
    url: https://www.jointcommission.org/resources/
    tier: free
  - name: ECRI Institute
