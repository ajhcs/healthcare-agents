...
services:
  - name: InterQual (Change Healthcare)
    url: https://www.changehealthcare.com/clinical-decision-support/interqual
    tier: paid
  - name: MCG (Milliman Care Guidelines)
    url: https://www.mcg.com/care-guidelines/
    tier: paid
  - name: CMS Medicare Benefit Policy Manual
    url: https://www.cms.gov/Regulations-and-Guidance/Guidance/Manuals/Internet-Only-Manuals-IOMs-Items/CMS012673
    tier: free
  - name: KEPRO (BFCC-QIO)
    url: https://www.keproqio.com/
    tier: free
  - name: CMS IPPS/OPPS Final Rules
