...
services:
  - name: CDC NHSN (National Healthcare Safety Network)
    url: https://www.cdc.gov/nhsn/
    tier: free
  - name: APIC (Association for Professionals in Infection Control)
    url: https://apic.org/
    tier: freemium
  - name: CMS Hospital-Acquired Condition Reduction Program
    url: https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment/AcuteInpatientPPS/HAC-Reduction-Program
    tier: free
  - name: CDC Antibiotic Stewardship
    url: https://www.cdc.gov/antibiotic-use/core-elements/index.html
    tier: free
  - name: AHRQ CUSP Toolkit
    url: https://www.ahrq.gov/hai/cusp/index.html
    tier: free
---
