...
services:
  - name: ASPR TRACIE (Technical Resources, Assistance Center, and Information Exchange)
    url: https://asprtracie.hhs.gov/
    tier: free
  - name: CMS Emergency Preparedness Rule Resources
    url: https://www.cms.gov/Medicare/Provider-Enrollment-and-Certification/SurveyCertEmergPrep
    tier: free
  - name: FEMA HSEEP (Homeland Security Exercise and Evaluation Program)
    url: https://preptoolkit.fema.gov/web/hseep-resources
    tier: free
  - name: FEMA National Incident Management System (NIMS)
    url: https://www.fema.gov/emergency-managers/nims
    tier: free
  - name: CDC Emergency Preparedness and Response
    url: https://emergency.cdc.gov/
    tier: free
  - name: Joint Commission Emergency Management Standards
