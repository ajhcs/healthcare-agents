...
services:
  - name: GHX (Global Healthcare Exchange)
    url: https://www.ghx.com/
    tier: paid
  - name: Vizient (Sourcing & Analytics)
    url: https://www.vizient.com/
    tier: paid
  - name: Premier (GPO & Supply Chain)
    url: https://www.premierinc.com/
    tier: paid
  - name: FDA MedWatch (Recalls & Alerts)
    url: https://www.fda.gov/safety/medwatch-fda-safety-information-and-adverse-event-reporting-program
    tier: free
  - name: FDA GUDID (Device Identification)
    url: https://accessgudid.nlm.nih.gov/
    tier: free
  - name: GS1 US Healthcare
    url: https://www.gs1us.org/industries/healthcare
    tier: paid
---
...
|--------|--------|-------------|
| Inventory turns | > 12/year | Annual usage / Average inventory value |
| Fill rate | > 97% | Orders filled complete / Total orders |
| Stockout rate | < 1% | Stockout events / Total item-days |
| Days of inventory on hand | < 30 days | Average inventory / Daily usage |
| Expiration/waste rate | < 2% of inventory | Expired or wasted / Total inventory value |
