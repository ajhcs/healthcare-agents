...
const required = [
  ...
  'lib/scale-physician-count-review.js',
  'lib/scale-physician-count-canonical.js',
  'lib/scale-emergency-department-count-review.js',
  'lib/scale-emergency-department-count-canonical.js',
  'lib/scale-essential-service-designation-count-review.js',
  'lib/scale-essential-service-designation-count-canonical.js',
  ...
  'scripts/generate-scale-physician-count-review.js',
  'scripts/verify-scale-physician-count-upstream.js',
  'scripts/test-scale-physician-count-review.js',
  'scripts/generate-scale-emergency-department-count-review.js',
  'scripts/verify-scale-emergency-department-count-upstream.js',
  'scripts/test-scale-emergency-department-count-review.js',
  'scripts/generate-scale-essential-service-designation-count-review.js',
  'scripts/verify-scale-essential-service-designation-count-upstream.js',
  'scripts/test-scale-essential-service-designation-count-review.js',
  ...
  'review-protocols/fixtures/scale-input-packets/physician-count/upstream-manifest.json',
  'review-protocols/fixtures/scale-input-packets/physician-count/upstream/handoff.json',
  'review-protocols/fixtures/scale-input-packets/physician-count/upstream/data-mcp/acquisition.json',
  'review-protocols/fixtures/scale-input-packets/physician-count/upstream/data-mcp/normalized-input.json',
  'review-protocols/fixtures/scale-input-packets/physician-count/upstream/data-mcp/producer-bound-input.json',
  'review-protocols/fixtures/scale-input-packets/physician-count/upstream/data-mcp/public-evidence-bundle.json',
  'review-protocols/fixtures/scale-input-packets/physician-count/handoff.json',
  'review-protocols/fixtures/scale-input-packets/emergency-department-count/upstream-manifest.json',
  'review-protocols/fixtures/scale-input-packets/emergency-department-count/upstream/handoff.json',
  'review-protocols/fixtures/scale-input-packets/emergency-department-count/upstream/data-mcp/acquisition.json',
  'review-protocols/fixtures/scale-input-packets/emergency-department-count/upstream/data-mcp/normalized-input.json',
  'review-protocols/fixtures/scale-input-packets/emergency-department-count/upstream/data-mcp/producer-bound-input.json',
  'review-protocols/fixtures/scale-input-packets/emergency-department-count/upstream/data-mcp/public-evidence-bundle.json',
  'review-protocols/fixtures/scale-input-packets/emergency-department-count/handoff.json',
  'review-protocols/fixtures/scale-input-packets/essential-service-designation-count/upstream-manifest.json',
  'review-protocols/fixtures/scale-input-packets/essential-service-designation-count/upstream/handoff.json',
  'review-protocols/fixtures/scale-input-packets/essential-service-designation-count/upstream/data-mcp/acquisition.json',
  'review-protocols/fixtures/scale-input-packets/essential-service-designation-count/upstream/data-mcp/normalized-input.json',
  'review-protocols/fixtures/scale-input-packets/essential-service-designation-count/upstream/data-mcp/producer-bound-input.json',
  'review-protocols/fixtures/scale-input-packets/essential-service-designation-count/upstream/data-mcp/public-evidence-bundle.json',
  'review-protocols/fixtures/scale-input-packets/essential-service-designation-count/handoff.json',
