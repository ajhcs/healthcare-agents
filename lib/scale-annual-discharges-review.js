...
const { validateConflictAnalysis } = require('./conflict-analysis');
...
function validateAnnualDischargesReviewHandoff(handoff, reviews, conflict, manifest, objects, artifactHashes, evidenceArtifacts) {
  ...
  for (const review of reviews || []) {
    ...
    messages.push(...validateAnnualDischargesReviewRequest({
    ...
    }, manifest, objects, artifactHashes, evidenceArtifacts));
  }
