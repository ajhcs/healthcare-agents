...
const kernel = createScaleInputFitnessKernel({
  ...
  reviewerRoles: [
    ...
    { protocolId: 'cso.operations-access-capacity.v1', agentSlug: 'operations-hospital-administrator', label: 'utilization-operations' }
  ],
  reviewHashKeys: ['methods', 'utilization_operations'],
  handoffFamilyBlockedField: 'annual_discharges_blocked_cell_count',
