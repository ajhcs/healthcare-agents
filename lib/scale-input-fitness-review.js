...
const kernel = createScaleInputFitnessKernel({
  expectedConflictRequestId: 'conflict-request:scale-operating-revenue:2026-07-17',
  expectedConflictOutputHash: 'sha256:419ffbc0b8dee60315a71eda29a537fb77e8a69c0fb63914054593b34ffe7ea4',
  expectedHandoffHash: 'sha256:a583646c95ec0ee06b84c89fff725c9e7ceefa98200de7d25744f5a2cc42ed72',
  ...
  familyCellMessage: 'blocked and unpopulated',
  ...
  reviewerRoles: [
    ...
    { protocolId: 'cso.healthcare-finance-capital.v1', protocolVersion: '1.0.0', agentSlug: 'revenue-finance-manager', competenceRole: 'healthcare_finance_capital', label: 'healthcare-finance' }
  ],
  ...
  handoffFamilyCellCountField: 'operating_revenue_blocked_cell_count',
  handoffFamilyConflictCountField: 'operating_revenue_open_conflict_count',
  handoffFamilyConflictRefsField: null,
