...
function validateScalePacketUpstream(manifest, objects, artifactHashes = {}) {
  const messages = [];
...
function validateScalePacketReviewRequest(request, manifest, objects, artifactHashes) {
  const messages = validateScalePacketUpstream(manifest, objects, artifactHashes);
...
function validateScalePacketReviewHandoff(handoff, reviews, conflict, manifest, objects, artifactHashes) {
  const messages = validateScalePacketUpstream(manifest, objects, artifactHashes);
