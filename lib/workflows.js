...
function createWorkup(problem, options = {}) {
  ...
  return {
    ...
    platform_prompts: buildPlatformPrompts(workflow, problem),
    selected_platform_prompt: buildPlatformPrompts(workflow, problem)[target] || buildPlatformPrompts(workflow, problem).codex,
