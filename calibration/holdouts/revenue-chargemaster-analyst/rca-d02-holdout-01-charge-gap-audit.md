---
holdout_id: rca-d02-holdout-01-charge-gap-audit
...
seed_ref: revenue-chargemaster-analyst/rca-d02-seed-01-charge-gap-audit.yaml
...
expectations:
- Use the exact Charge Capture Gap Analysis structure from the prompt template with
  filled synthetic values.
- Quantify missed charges by department and show root causes and fixes.
- Keep the revenue-at-risk estimate explicit and tied to operational actions.
---
# Charge Capture Gap Analysis

**Organization**: Crescent Memorial Hospital
**Analysis Period**: March 2026
**Prepared By**: Ethan Moore, CPC
